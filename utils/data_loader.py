...
def get_data_loader(args):
    ...
    if args.dataset == 'mnist':
        ...
        train_dataset = dset.CIFAR10(root=args.dataroot, train=True, download=False, transform=trans)
        test_dataset = dset.CIFAR10(root=args.dataroot, train=False, download=False, transform=trans)
